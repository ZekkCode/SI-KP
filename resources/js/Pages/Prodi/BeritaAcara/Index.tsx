        ...
        <div className="bg-white rounded-xl border border-outline-variant/60 shadow-sm p-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg border border-outline-variant/50 text-sm focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
            />
          </div>
              ...
              <tr key={pendaftaran.id} className="hover:bg-slate-50/70 transition-colors">
                ...
                <ModernTableTd className="px-6 py-4">
                  <div className="flex items-center gap-3.5">
                    <div className="w-10 h-10 rounded-md flex items-center justify-center font-bold text-sm bg-primary/10 text-primary shrink-0 ring-1 ring-primary/20">
                ...
                <ModernTableTd className="px-6 py-4">
                  {pendaftaran.url_file ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 text-primary hover:text-primary-container bg-primary/5 hover:bg-primary/10 px-3.5 py-1.5 rounded-lg transition-all font-semibold text-xs border border-primary/20"
                    >
                      <FileText size={15} />
                      Lihat & Unduh Dokumen
                    </a>
                ...
                <ModernTableTd className="px-6 py-4 text-right">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white px-3.5 py-1.5 rounded-lg text-xs font-semibold shadow-sm transition-all active:scale-95"
                  >
                    <CheckCircle size={15} />
                    Setujui Validasi
                  </button>
