...
export default function Edit({ instansi }: Props) {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('prodi.instansi.update', instansi.id));
  };

  return (
    <div className="animate-in fade-in duration-300 p-4 md:p-8">
      <Head title="Edit Instansi" />
      ...
      <div className="mb-8">
        ...
        <p className="text-on-surface-variant mt-2">Perbarui informasi instansi tempat Kerja Praktik.</p>
      </div>
