...
<body onload="window.print()">
    <div class="cetak-container">
        ...
        <div class="judul-surat">
            BERITA ACARA HASIL PENILAIAN PEMBIMBING LAPANGAN (INSTANSI)
        </div>

        <div class="data-mahasiswa">
            <p>Berdasarkan penilaian yang telah dilakukan oleh Pembimbing Lapangan Instansi/Perusahaan, berikut adalah hasil evaluasi Kerja Praktik untuk mahasiswa:</p>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $rapor['pembimbing_lapangan'] }}</td>
                </tr>
            </table>
        </div>
        ...
        <table class="tabel-nilai">
            ...
            <tbody>
                @forelse($rapor['rincian_instansi'] as $index => $rincian)
                <tr>
                    <td class="angka">{{ $index + 1 }}</td>
                    <td>{{ ucfirst($rincian['komponen']) }}</td>
                    <td class="angka">{{ $rincian['nilai'] }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="3" style="text-align: center;">Belum ada penilaian dari instansi.</td>
                </tr>
                @endforelse
                <tr>
                    <td colspan="2" style="text-align: right; font-weight: bold; padding-right: 10px;">Nilai Agregat Instansi</td>
        ...
        <div style="margin-bottom: 20px;">
            <p>Penilaian ini merupakan prasyarat untuk pelaksanaan Sidang/Penilaian Akhir Kerja Praktik oleh Dosen Pembimbing.</p>
        </div>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        Pembimbing Lapangan,
                        <br><br><br><br><br><br>
                        <span class="nama-ttd">{{ $rapor['pembimbing_lapangan'] }}</span><br>
                    </td>
                </tr>
            </table>
        </div>
